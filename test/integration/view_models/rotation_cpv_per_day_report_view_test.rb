...
class RotationCpvPerDayReportViewTest < ActiveSupport::TestCase
  def setup
    @spots = [
      @first = Spot.create!(runs_at: "01/02/2016 8:30 AM", creative: "TEST001H", spend_cents: 12_050, views: 100),
      @second = Spot.create!(runs_at: "01/02/2016 11:30 AM", creative: "TEST001H", spend_cents: 24_050, views: 110),
      @third = Spot.create!(runs_at: "01/02/2016 3:30 PM", creative: "TEST002H", spend_cents: 50_000, views: 80),
      @fourth = Spot.create!(runs_at: "01/02/2016 3:34 PM", creative: "TEST002H", spend_cents: 40_000, views: 90),
      @fifth = Spot.create!(runs_at: "01/02/2016 3:40 PM", creative: "TEST001H", spend_cents: 40_000, views: 110),
      @sixth = Spot.create!(runs_at: "02/02/2016 7:30 AM", creative: "TEST001H", spend_cents: 70_000, views: 200),
      @seventh = Spot.create!(runs_at: "02/02/2016 7:30 PM", creative: "TEST002H", spend_cents: 70_000, views: 300)
    ]
  ...
  test "rotation 1 first day" do
    ...
    assert_equal Money.new(12_050 + 24_050), rot1_first_day[:total_spend]
  ...
  test "rotation 1 second day" do
    ...
    assert_equal Money.new(70_000), rot1_second_day[:total_spend]
  ...
  test "rotation 2 first day" do
    ...
    assert_equal Money.new(50_000 + 40_000 + 40_000), rot2_first_day[:total_spend]
  ...
  test "rotation 2 second day" do
    ...
    assert_equal Money.new(70_000), rot2_second_day[:total_spend]
